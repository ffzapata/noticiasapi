...
namespace NoticiasWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<NoticiasDBContext>(opciones => opciones.UseSqlServer("Data Source=DESKTOP-49DH49H\\SQLEXPRESS;Initial Catalog=Noticias;Persist Security Info=True;User ID=sa;Password=Planetcolor2018*"));
